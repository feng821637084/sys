...
<body>
    <form action="showQdDataBySws.html?action=1" method="post" name="recordsForm" id="recordsForm">
		<div class="search_div">
				...
				选择CP：
				<select name="pDataId" id="pDataId" style="vertical-align: middle;" onchange="setPData();">
