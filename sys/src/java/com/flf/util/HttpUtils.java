	...
	public static void main(String[] args) {
		for (int i =0  ; i < 20000 ; i ++) {
			...
			try {
				...
				//s = URLGet("http://hq.sinajs.cn/list=s_sh000001", null, URL_PARAM_DECODECHARSET_UTF8);
				s = URLGet("http://qt.gtimg.cn/q=s_sh000001", null, URL_PARAM_DECODECHARSET_UTF8);
				String[] strs = s.split("~");
				double dou1 = Double.valueOf(strs[3]);
//				System.out.println("qq===" + i + " " + s);
				s = URLGet("http://hq.sinajs.cn/list=s_sh000001", null, URL_PARAM_DECODECHARSET_UTF8);
				strs = s.split(",");
				double dou2 = Double.valueOf(strs[1]);
//				System.out.println("sina===" + i + " " + s);
				System.out.println("qq=" + dou1 + " sina=" + dou2);
				Thread.sleep(500 * 2 );
			} catch (Exception e) {
